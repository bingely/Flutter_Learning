...
class ThemeProvider extends ChangeNotifier {
  ...
  void syncTheme() {
    String theme = SpUtil.getString(AppConstants.theme);
  ...
  void setTheme(ThemeMode themeMode) {
    SpUtil.putString(AppConstants.theme, themes[themeMode]);
    notifyListeners();
  }
  ...
  getTheme({bool isDarkMode: false}) {
    return ThemeData(
      ...
      // 页面背景色
      scaffoldBackgroundColor: isDarkMode ? Colours.dark_bg_color : AppColors.bgColor,
      // 主要用于Material背景色
