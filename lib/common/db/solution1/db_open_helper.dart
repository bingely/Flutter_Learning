...
class DbOpenHelper{
  ...
  /// 表语句
   static void creteTables(Database db) async {
    ...
    // 离线消息表
    String sessionSql = 'CREATE TABLE SessionMsg (id TEXT PRIMARY KEY, userId TEXT, avatars TEXT, name TEXT, nameIndex TEXT, title TEXT, subTitle TEXT, time INTEGER, type INTEGER, isDisturbMode INTEGER, isTopChat INTEGER)';
