...
class SearchChatItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        // 跳到对应的聊天页面
        Navigator.pushNamed(context, RouteName.chat, arguments: SessionMsg(title: '${chatData.nickName}', userId: chatData.chatId));
      },
      //按下回调处理
      child: Container(
        height: 68,
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        TimelineUtil.formatByDateTime(
                            DateUtil.getDateTimeByMs(chatData.time)),
                        style:
