...
import 'package:flutter_qyyim/pages/chat/map/sliver_custommaphead.dart';
...
/// 定位地图
class MapLocationPageTest extends StatefulWidget {
  @override
  _MapLocationPageTestState createState() => new _MapLocationPageTestState();
}

class _MapLocationPageTestState extends State<MapLocationPageTest> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(body: CustomScrollView(
      slivers: <Widget>[
        SliverPersistentHeader(
          pinned: true,
          delegate: SliverCustomMapHeaderDelegate(
              title: '哪吒之魔童降世',
              collapsedHeight: 310,
              expandedHeight: 500,
